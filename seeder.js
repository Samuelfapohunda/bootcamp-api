...
mongoose.connect(process.env.MONGO_URI, {
 ...
 const bootcampFile = fs.readFileSync('./_data/bootcamps.json', 'utf-8')
 const bootcamps = JSON.parse(bootcampFile);

 const courseFile = fs.readFileSync('./_data/courses.json', 'utf-8')
 const courses = JSON.parse(courseFile);

 const userFile = fs.readFileSync('./_data/users.json', 'utf-8')
 const users = JSON.parse(userFile);

 const reviewFile = fs.readFileSync('./_data/reviews.json', 'utf-8')
